...
public class MongodbGeohashServiceImpl implements MongodbGeohashService {
    ...
    public void findFixedDistance(double x, double y, Integer minDistance, Integer maxDistance, boolean spherical) {
        NearQuery nearQuery = NearQuery.near(new GeoJsonPoint(x, y)) //指定坐标
                .minDistance(minDistance,Metrics.KILOMETERS) //最小距离,单位指定公里
                .maxDistance(maxDistance,Metrics.KILOMETERS) //最大距离，单位指定公里
                .spherical(true)
